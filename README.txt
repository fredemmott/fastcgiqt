...
- UNIX-FD: Works with Apache, via mod_fastcgi or mod_fcgid. This is what's in the
...
- TCP: Works with lighttpd and cherokee. When this, and a corresponding port number
	are configured, your application will listen on all IP addresses, on the
	specified port.
